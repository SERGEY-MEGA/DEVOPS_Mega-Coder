...
**Репозиторий проекта:** [gitlab.com/Mega.93/deveps-mega-coder](https://gitlab.com/Mega.93/deveps-mega-coder)

---

Документ соответствует требованиям к отчёту: описание приложения и архитектуры, инструкция запуска, переменные окружения, схема инфраструктуры, описание pipeline, Ansible, место для скриншотов Grafana.
